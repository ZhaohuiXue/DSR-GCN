...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, changel: int, class_count: int):
        ...
        # self.CNN_Branch2= SSConv(60, 128, kernel_size=5)
        # self.CNN_Branch2 = SSConv(60, 256, kernel_size=7)
        # self.CNN_Branch2= SSConv(60, 128, kernel_size=7)
    ...
    def forward(self, x: torch.Tensor,full=False,contrast=False):
        ...
        '''
        # (n, h, w, c) = x.shape
        # CNN_result = self.CNN_Branch3(CNN_result)
        # CNN_result = self.CNN_Branch4(CNN_result)
        # CNN_result = self.CNN_Branch5(CNN_result)
        # CNN_result = self.CNN_Branch6(CNN_result)
