...
OAmean = []
for (FLAG, curr_train_ratio, Scale) in [(3, 0.1,500)]:
    # for t in [90]:
    for sampless in [5]:
        smallscale = 400
        for t in [128]:
            ...
            for curr_seed in Seed_List:
                ...
                contrastlearning(400, contrast_loader,labeled_trainloader,optim_contrast,optimizer, SToptimizer,Sptransnet ,net,lentrainsample,lencontrast,GCNnet,GCNDATA,optimizer1, train_samples_gt_onehot, train_label_mask)
                CNNtrainend = time.time() - CNNtrainstart
                print('ALL traing time :%.4f'% CNNtrainend)
            ...
            f = open('result/txt/' + str(sampless) + 'samples.txt', 'a+')
            OA_results = '\n======================' \
